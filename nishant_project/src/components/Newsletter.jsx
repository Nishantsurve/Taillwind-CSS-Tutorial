...
<div className='lg:col-span-2 my-4'>
    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Want tips and tricks to improve performance</h1>
    <p>Sig up to our System and stay  up to date</p>
</div>
